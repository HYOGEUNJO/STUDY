...
namespace _0102
{
    internal class WhatIsCollection
    {
        public void CollectionDesc()
        {
            ...
            // 데이터를 그룹으로 묶어 관리할 떄는 일반적으로 배열로 관리한다.
            // 배열은 크기가 고정되어 있다. 그러므로 새로운 데이터를 추가할 수 없다. 이러한 단점을 제거한 것이 바로 컬렉션이다.
            ...
            Dictionary<string, int> inventory = new Dictionary<string, int>(); // 키, 값 순서로 선언
